...
inline int lower_bound(vector<int>& nums, int target) {	// 闭区间
...
inline int lower_bound2(vector<int>& nums, int target) {	// 左闭右开
...
inline int lower_bound3(vector<int>& nums, int target) {	// 开区间
...
// C++11 引入的algorithm库
inline int example(vector<int>& nums, int target) {
...
inline int example2(vector<int>& nums, int target) {
